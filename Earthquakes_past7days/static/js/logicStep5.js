  ...
  L.geoJSON(data,{
    ...
    legend.onAdd = function(){
        ...
        for (var i=0; i<magnitudes.length; i++){
            ...
            // The conditional or question mark operator, represented by a ?, is one of the most powerful features in JavaScript. 
            ...
            // Such as: Condition to test ? Value if true : Value if false
